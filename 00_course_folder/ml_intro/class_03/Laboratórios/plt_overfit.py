...
class overfit_example:
    """exemplo de sobreajuste do gráfico"""
    ...
    def __init__(self, regularize=False):
        ...
        self.bfitdata = Button(self.axfitdata, "treinar!", color=dlc["dlblue"])
        ...
        self.typebut = button_manager(
            fig,
            [0.4, 0.07, 0.15, 0.15],
            ["Regressão", "Categórico"],
            [False, True],
            self.toggle_type,
        )

        self.fig.text(0.1, 0.02 + 0.21, "Grau", fontsize=12)
    ...
    def logistic_data(self, redraw=False):
        ...
        self.ax[0].set_title(
            "Exemplo de OverFitting: conjunto de dados categóricos com ruído"
        )
        self.ax[0].text(
            0.5,
            0.93,
            "Clique no gráfico para adicionar dados. Segure [Shift] para dados azuis (y = 0).",
            fontsize=12,
            ha="center",
    ...
    def linear_data(self, redraw=False):
        ...
        self.ax[0].set_title(
            "Exemplo de OverFitting: conjunto de dados de regressão (quadrático com ruído)",
            fontsize=14,
        )
        ...
        self.ax[0].text(
            0.5,
            0.93,
            "Clique no gráfico para adicionar dados",
            fontsize=12,
            ha="center",
            transform=self.ax[0].transAxes,
            color=dlc["dlblue"],
